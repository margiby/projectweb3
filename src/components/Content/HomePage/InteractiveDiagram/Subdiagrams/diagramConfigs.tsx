...
/**
 * Konfigurationen für Subdiagramme
 */

export const diagramConfigs: Record<string, FlexibleDiagramConfig> = {

// Diagramm für Komponenten
  komponenten: {
    nodes: [
    ...
    // Diagramm für Versorgungskonzepte
  versorgungskonzepte: {
    nodes: [
